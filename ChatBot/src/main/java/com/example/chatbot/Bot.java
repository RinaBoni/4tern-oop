...
public class Bot {
    ...
    private final String[] SIMPLE_PHRASES = {   //Общие фразы (когда написали что-то не понятное)
    ...
    private final String[] SIMPLE_ANSWERS = {  //Ответы (когда спросили что-то не понятное)
